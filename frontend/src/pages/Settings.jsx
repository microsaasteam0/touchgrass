...
const Settings = () => {
  ...
  const pageStyles = `
    /* Settings CSS - RESPONSIVE VERSION */
    * {
  ...
  const renderSettingsContent = () => {
    ...
    switch (activeCategory) {
      case 'data':
        return (
          <div className="settings-main">
            <div className="settings-section data-export">
              <div className="section-header">
                <div className="section-icon">
                  💾
                </div>
          ...
          <div className="settings-main">
            <div className="settings-section">
              <div className="section-header">
                ...
                <div className="section-content">
                  <h2 className="section-title">{category.label} Settings</h2>
                  <p className="section-description">Connect your fitness apps and services</p>
                </div>
              </div>
                ...
                {Object.entries(settings[activeCategory]).map(([key, value]) => (
                  <div key={key} className="integration-card">
                    ...
                    <div className="integration-info">
                      ...
                      <p className={`integration-status ${value ? 'connected' : ''}`}>
              ...
              <div className="settings-grid">
                {Object.entries(settings[activeCategory]).map(([key, value]) => (
                  <div key={key} className="setting-item">
                    ...
                    ) : key === 'sessionTimeout' || key === 'deleteDataAfter' ? (
                      <div className="select-container">
                        <select
                          className="select-styled"
                          value={value}
      ...
      <div style={{
        ...
        {toasts.map((toast) => (
          <div
            key={toast.id}
            style={{
              background: toast.type === 'success' ? 'rgba(34, 197, 94, 0.95)' : 'rgba(59, 130, 246, 0.95)',
              color: 'white',
              padding: '1rem',
              borderRadius: '12px',
              border: '1px solid rgba(255, 255, 255, 0.1)',
