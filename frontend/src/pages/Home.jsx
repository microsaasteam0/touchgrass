...
const LandingPage = ({ onStart }) => {
  ...
  // NEW: Handle View All Articles
  const handleViewAllArticles = () => {
    navigate('/blogs');
  };

  // NEW: Handle individual blog click
    ...
    <>
      ...
      <style>
        {`
          ...
          * {
          ...
          /* Mobile First Approach - Start with base mobile styles */
          .landing-page {
            width: 100%;
            min-width: 280px;
            overflow-x: hidden;
            /* background and color handled by theme classes */
          ...
          /* Still Have Questions - Mobile First */
          .question-cta {
            text-align: center;
            margin-top: 3rem;
            padding: 2rem;
          ...
          /* Social Media Links - Mobile First */
          .social-section {
            text-align: center;
            margin-top: 3rem;
          }
          ...
          /* Extreme Mobile Screens (320px and below) */
          @media (max-width: 320px) {
            .hero-title {
              font-size: 2rem;
            }
      ...
      <div className="landing-page">
        ...
        <div style={{
          ...
          Current theme: {document.body.className}
        </div>
        ...
        <section className="hero-section">
          ...
          >
            ...
            <motion.p 
              ...
              className="hero-subtitle"
            >
              A simple daily habit to get outside, stay active, and stay accountable.<strong>With TouchGrass:</strong> 
              <strong> Verify your outdoor time,</strong> build streaks and <strong>join thousands building real world discipline</strong> through the simplest, most powerful habit there is.
            </motion.p>
        ...
        <section id="blogs" className="section-container blogs-section">
          <div className="blogs-container container">
            ...
            <div className="blogs-grid">
              {blogs.map((blog, index) => (
                <motion.div
                  ...
                  className={`blog-card glass ${activeBlog === index ? 'active' : ''}`}
                  onMouseEnter={() => setActiveBlog(index)}
                  onClick={() => handleBlogClick(blog.id)} // NEW: Click handler for individual blog
                >
                  <div 
                    className="blog-badge"
                    style={{ 
                  ...
                  <div className="blog-content">
                    ...
                    <button className="blog-read-more" onClick={(e) => {
                      e.stopPropagation();
            ...
            <motion.div 
              ...
              style={{ textAlign: 'center', marginTop: '4rem' }}
            >
              <button className="cta-button button-secondary" style={{ minWidth: '200px' }} onClick={handleViewAllArticles}>
                <BookOpen size={16} />
                View All Articles
              </button>
            </motion.div>
          ...
          <div className="footer-grid container">
            ...
            <div>
              ...
              <ul className="footer-links">
                ...
                <li className="footer-link">
  {/* Change from scroll to navigation */}
  <Link 
    to="/blog" 
    style={{
      color: '#94a3b8',
  ...
  >
    Blog & Insights
          ...
          <div className="footer-bottom container">
            ...
            <p style={{ fontSize: '0.75rem', color: '#64748b', marginTop: '1.5rem', fontStyle: 'italic', textAlign: 'center' }}>
              Conversations are ephemeral and accountability-driven. Your discipline is your status.
            </p>
          </div>
        </footer>
